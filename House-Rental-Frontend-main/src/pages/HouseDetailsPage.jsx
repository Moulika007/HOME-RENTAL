...
import { MapPin, ArrowLeft, Check, User, ChevronLeft, ChevronRight } from 'lucide-react';
...
const HouseDetailsPage = () => {
    ...
    const handleBook = async () => {
        ...
        if (user.role === 'owner') return setToast({ message: "Owners cannot book houses.", type: 'warning' });

        try {
            const res = await fetch(`${API_BASE}/api/houses/${id}/request`, {
                method: 'PUT',
                headers: {
            ...
            if (res.ok) {
                setToast({ message: "Booking Request Sent! Check your Renter Dashboard for status.", type: 'success' });
